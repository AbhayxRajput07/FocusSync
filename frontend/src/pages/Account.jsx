...
import { Flame, Trophy, Star, Zap, Clock, CalendarDays, Activity } from 'lucide-react';
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4">
        <h2 className="text-xl font-bold">Please log in to view your account.</h2>
      </div>
    );
  }

  return (
    <div className="w-full max-w-5xl mx-auto rounded-[32px] bg-[#F8FAFC] border border-[#E2E8F0] shadow-sm overflow-hidden mt-6 pb-6">
      {/* Top Banner Area */}
      <div className="relative bg-gradient-to-br from-[#93C5FD] to-[#3B82F6] p-8 md:p-10 pointer-events-none overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8 pointer-events-auto">
            ...
            {/* XP Progress Card */}
            <div className="md:w-[240px] bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-5 text-white flex flex-col justify-center mt-6 md:mt-0">
